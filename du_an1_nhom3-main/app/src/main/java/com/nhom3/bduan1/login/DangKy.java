...
public class DangKy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable eyeOpen = AppCompatResources.getDrawable(context, R.drawable.matmo);
        Drawable eyeClosed = AppCompatResources.getDrawable(context, R.drawable.mat);


        View.OnTouchListener togglePasswordVisibility = (v, event) -> {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                EditText editText = (EditText) v;
                int drawableEndIndex = editText.getWidth() - editText.getPaddingEnd();
                if (event.getRawX() >= (editText.getRight() - drawableEndIndex)) {
